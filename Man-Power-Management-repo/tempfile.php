...
<p>&nbsp;</p>
    <h1 style="text-align: center; padding-right:10%; ">Update Employee</h1>
    <p>&nbsp;</p>
    <div class="container">
        ...
        if(isset($_GET['edit'])) 
           {
             ...
             $query = "SELECT * FROM employee_list where sqlid='$ID'";
